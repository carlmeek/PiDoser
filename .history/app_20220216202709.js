...
async function go() {
    ...
    params.probes= {
        orp:new probe.Probe(params,'orp',logic,pcf),
        ph:new probe.Probe(params,'ph',logic,pcf),
        tds:new probe.Probe(params,'tds',logic,pcf),
        temp:new probe.Probe(params,'temp',logic,pcf)
    }
