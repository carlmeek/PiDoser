...
class Probe{
    ...
    constructor(passparams,name,passlogic){
       ...
       switch (name){
           ...
           case 'ph'  : { this.title = 'pH'          ; this.title = 'pH'          ; this.desc='Acidity'                ; this.direction=false; break }
           case 'tds' : { this.title = 'TDS'         ; this.title = 'TDS'         ; this.desc='Total Dissolved Solids' ; this.direction=false; break }
           case 'temp': { this.title = 'Temperature' ; this.title = 'Temperature' ; this.desc='Temperature'            ; this.direction=true; break }
       }
    }
