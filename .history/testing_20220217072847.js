...
async function testingPoll() {
    ...
    if (typeof(founddevs)=='undefined') {
        ...
        for (var i=0; i<founddevs.length; i++) {
            ...
            switch (item) {
                case 98:
                    var device = new atlas.ORP(i2c_bus,item,info)
                    ...
                    break;
                case 99:
                    var device = new atlas.pH(i2c_bus,item,info)
                    ...
                    break;
                case 100:
                    var device = new atlas.EC(i2c_bus,item,info)
                    ...
                    break;
                case 102:
                    var device = new atlas.EZODevice(i2c_bus,item,info)
