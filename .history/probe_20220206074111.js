...
class Probe{
    ...
    constructor(passparams,name){
       ...
       switch (name){
           ...
           case 'ph'  : { this.title = 'pH'          ; this.desc='Acidity'                ; this.myParams=params.orp ;break }
           case 'tds' : { this.title = 'TDS'         ; this.desc='Total Dissolved Solids' ; this.myParams=params.orp ;break }
           case 'temp': { this.title = 'Temperature' ; this.desc='Temperature'            ; this.myParams=params.orp ;break }
       }
    }
